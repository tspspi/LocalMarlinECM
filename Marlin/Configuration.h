...
#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors   // TSP 20181205
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 10 /* 8 */
  #define GRID_MAX_POINTS_Y 15 /* 15 */
