...
/*
   Configure the additional multi PSU power switch
*/
...
/*
   Enable PSU1 whenever it is disabled and a bed temperature > 0 has been set
   Disable when bed temperature 0 is set.
*/
#define MULTIPSU_AUTOENABLE_BED_PSU1 1
...
// Result from PID Autotune
//    M303 E-1 C8 S90
#define  DEFAULT_bedKp 150.39
#define  DEFAULT_bedKi 29.61
#define  DEFAULT_bedKd 190.96
...
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 15, 9000 }
...
*/
#define DEFAULT_XJERK                   1 /* reduced from 5 */
#define DEFAULT_YJERK                  1 /* reduced from 5 */
...
*/
#define PROBING_HEATERS_OFF       // Turn heaters off when probing  // TSP 20181205
// #define PROBING_FANS_OFF          // Turn fans off when probing     // TSP 20181205
#define DELAY_BEFORE_PROBING 500  // (ms) To prevent vibrations from triggering piezo sensors   // TSP 20181205 // TSP 20190916 200->500
...
/**
     ...
     #define Y_PROBE_OFFSET_FROM_EXTRUDER 10
      ...
      (0,0)
*/
// #define X_PROBE_OFFSET_FROM_EXTRUDER 2  // X offset: -left  +right  [of the nozzle] // TSP
// #define Y_PROBE_OFFSET_FROM_EXTRUDER 37  // Y offset: -front +behind [the nozzle]   // TSP 20181205 from 32 to 37
...
#define Y_BED_SIZE 170 /* 92 */ /* 205 -> 150 @ 20191108 */ /* -> 180 @ 20201010; Linited because of Y forces ... */
...
/* #define LEFT_PROBE_BED_POSITION 20
  #define RIGHT_PROBE_BED_POSITION 114
  #define FRONT_PROBE_BED_POSITION 46
  #define BACK_PROBE_BED_POSITION 182 */
/*
  #define LEFT_PROBE_BED_POSITION  (X_PROBE_OFFSET_FROM_EXTRUDER+1)
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE-1)
  #define FRONT_PROBE_BED_POSITION (Y_PROBE_OFFSET_FROM_EXTRUDER+1)
...
#define EXTRAPOLATE_BEYOND_GRID     // TSP 20181204: Removed // TSP 20181205 ADDED

//
// Experimental Subdivision of the grid by Catmull-Rom method.
// Synthesizes intermediate points to produce a more detailed mesh.
//
// #define ABL_BILINEAR_SUBDIVISION // TSP 20181205 disabled
